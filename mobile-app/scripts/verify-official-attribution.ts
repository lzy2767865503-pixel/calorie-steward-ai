...
assert.match(androidBuildGradle, /versionName ["']1\.2\.3["']/);
...
assert.match(read("ios/app/Info.plist"), /<key>CFBundleShortVersionString<\/key>\s*<string>1\.2\.3<\/string>/);
assert.match(read("ios/app/Info.plist"), /<key>CFBundleVersion<\/key>\s*<string>7<\/string>/);
assert.match(read("src/screens/SettingsScreen.tsx"), /卡路里管家 v1\.2\.3|Calorie Steward v1\.2\.3/);
